...
describe('AdmissionLocationHelper', () => {
    it('Should return admission location by Uuid', () => {
        expect(admissionLocationHelper.getAdmissionLocation(admissionLocations, 'bb0e512e-d225-11e4-9c67-080027b662ec'))
            .toEqual({
                'name': 'Labour Ward',
        ...
        expect(admissionLocationHelper.getAdmissionLocation(admissionLocations, 'baf83667-d225-11e4-9c67-080027b662ec'))
            .toEqual({
    ...
    it('Should return higher level admission locations', () => {
        expect(admissionLocationHelper.getHigherLevelAdmissionLocations(admissionLocations))
            .toEqual({
    ...
    it('Should return child admission locations by parent location uuid', () => {
        expect(admissionLocationHelper.getChildAdmissionLocations(admissionLocations, 'baf7bd38-d225-11e4-9c67-080027b662ec'))
            .toEqual({
        ...
        expect(admissionLocationHelper.getChildAdmissionLocations(admissionLocations, null))
            .toEqual({
                'baf7bd38-d225-11e4-9c67-080027b662ec': {
                    'isHigherLevel': true,
                    'isOpen': false,
        ...
        expect(admissionLocationHelper.getChildAdmissionLocations(admissionLocations, 'bb0e512e-d225-11e4-9c67-080027b662ec'))
            .toEqual({});
    });
    ...
    it('Should return parents location upto higher level', () => {
        ...
        expect(admissionLocationHelper.navigateUpToHigherLevel(admissionLocations, [], 'bb0e512e-d225-11e4-9c67-080027b662ec'))
            .toEqual([{
                'isHigherLevel': true,
                'isOpen': false,
                'name': 'Labour Ward',
        ...
        expect(admissionLocationHelper.navigateUpToHigherLevel(admissionLocations, [], 'baf83667-d225-11e4-as58-080027b662ec'))
            .toEqual([{
                'isHigherLevel': true,
                'isOpen': false,
                'name': 'General Ward',
    ...
    it('Should return parent admission location', () => {
        expect(admissionLocationHelper.getParentAdmissionLocation(admissionLocations, 'baf83667-d225-11e4-as58-080027b662ec'))
            .toEqual({
                'isHigherLevel': false,
                'isOpen': false,
                'name': 'General Ward - floor-2',
        ...
        expect(admissionLocationHelper.getParentAdmissionLocation(admissionLocations, 'bb0e512e-d225-11e4-9c67-080027b662ec'))
            .toEqual(null);
    });
