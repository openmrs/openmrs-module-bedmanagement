...
describe('BedLayout', () => {
    ...
    beforeAll(() => {
        ...
        mock.onGet('https://192.168.33.10/openmrs/ws/rest/v1/admissionLocation/bb0e512e-d225-11e4-9c67-080027b662ec')
            .reply(200, data);
    });

    it('Should render bed block properly', async () => {
        const bedLayout = shallow(<BedLayout activeUuid='bb0e512e-d225-11e4-9c67-080027b662ec' admissionLocationFunctions={testProps.admissionLocationFunctions}/>);
        ...
        const notYetSetBedLayout = shallow(<BedLayout activeUuid='baf83667-d225-11e4-as58-080027b662ec' admissionLocationFunctions={testProps.admissionLocationFunctions}/>);
        await testProps.sleep(100);
    ...
    it('Should trigger event handler', async () => {
        ...
        const notYetSetBedLayout = mount(<BedLayout activeUuid='baf83667-d225-11e4-as58-080027b662ec'
            admissionLocationFunctions={testProps.admissionLocationFunctions}/>);
        await testProps.sleep(100);
        notYetSetBedLayout.update();

        notYetSetBedLayout.find('label').at(0).simulate('click');
        ...
        notYetSetBedLayout.find('label').at(1).simulate('click');
