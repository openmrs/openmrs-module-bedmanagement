...
public class BedTypeResource extends DelegatingCrudResource<BedType> {
    ...
    protected PageableResult doGetAll(RequestContext context) throws ResponseException {
        List<BedType> bedTypeList = Context.getService(BedManagementService.class).getBedTypesByName(null, context.getLimit(), context.getStartIndex());
    ...
    protected PageableResult doSearch(RequestContext context) {
        ...
        List<BedType> bedTypeList = Context.getService(BedManagementService.class).getBedTypesByName(name, context.getLimit(), context.getStartIndex());
        return new AlreadyPaged<BedType>(context, bedTypeList, false);
    }
