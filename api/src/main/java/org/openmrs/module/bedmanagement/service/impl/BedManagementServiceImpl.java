...
public class BedManagementServiceImpl extends BaseOpenmrsService implements BedManagementService {
    ...
    private BedLocationMappingDao bedLocationMappingDao;

    private AdmissionLocationDao admissionLocationDao;

    private BedPatientAssignmentDao bedPatientAssignmentDao;
    ...
    public BedPatientAssignment getBedPatientAssignmentByUuid(String uuid) {
        return bedPatientAssignmentDao.getBedPatientAssignmentByUuid(uuid);
    }
    ...
    public Bed getBedByUuid(String bedUuid) {
        return bedDao.getBedByUuid(bedUuid);
    }
